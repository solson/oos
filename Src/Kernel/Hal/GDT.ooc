...
// defined in GDT.asm
loadGDT: extern proto func (GDTDescriptor*)
...
initGDT: func {
    ...
    setGDTEntry(1, 0x00000000, 0xFFFFF, 0b00, true,  false, true, true, true)
    setGDTEntry(2, 0x00000000, 0xFFFFF, 0b00, false, false, true, true, true)

    loadGDT(gdtd&)
}

setGDTEntry: func (n: SizeT, base, limit: UInt32, privl: UInt, ex, dc, rw, gr, sz: Bool) {
